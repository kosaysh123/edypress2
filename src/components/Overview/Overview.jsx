...
function Overview() {
  return (
    <div className="ka-Overview-countener">
    <p className="ka-Overview-countener-p">LearnPress is a comprehensive WordPress LMS Plugin for WordPress.
        ...
        high-quality WordPress Plugin that definitely helps you with making money from
         your WordPress Based LMS. Just try and see how amazing it is. LearnPress WordPress 
         Online Course plugin is lightweight and super powerful with lots of Add-Ons to empower
