...
import "../HeadAllCourses/HeadAllCourses.css";
import ToCardCourse from "../ToCardCourse/ToCardCourse";
import ToCardLineCourse from "../ToCardLineCourse/ToCardLineCourse";

function HeadAllCourses() {
  ...
  return (
    <>
      ...
      <div className="ko-HeadAllCourses mb-5">
        <h1 className="ko-HeadAllCourses-h1">All Courses</h1>
      ...
      <div className="ko-all-course">
          ...
          {show1 ? <ToCardCourse/> || !show1  :  <ToCardLineCourse/>  }
        </div>
    </>
  );
}

export default HeadAllCourses;
