        ...
        <div className="ko-form-comment">
          <div className="ko-form-said1">
            <input
              type="text"
              placeholder="Name*"
              className="ko-form-said1-text"
            />
            <input
              type="email"
              placeholder="Email*"
              className="ko-form-said1-email"
            />
          </div>
          <textarea
            name=""
          ...
          <div className="ko-form-check">
            <input
              ...
              name=""
              id=""
              className="ko-form-check-checkbox"
            />
